...
def main():
    ...
    parser.add_argument("--out_path", default=None,
                         help="Defaults to results/usleep_fold_{fold}_results.txt")
    ...
    out_path = Path(args.out_path) if args.out_path else Path(f"results/usleep_fold_{args.fold}_results.txt")
    out_path.parent.mkdir(parents=True, exist_ok=True)
    with open(out_path, "w") as f:
        f.write(f"U-Sleep fold {args.fold} ({args.pred_folder}) test results\n")
